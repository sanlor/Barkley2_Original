    ...
    with (event) {
        ...
        //-----------------
            ...
            with (yes) {
                ...
                if (scr_quest_get_state("crustDoorSolo") <= 1) {
                    scr_event_build_dialogue("X114JAM9", s_port_hoopz, "(I don't know... maybe I'll come back later.)");
        ...
        //--------------------
            ...
            if (scr_quest_get_state("csComplete") == 0) { // Cyberspear incomplete
                ...
                if (scr_quest_get_state("crustDoorIncomplete") == 0) { // 0 door attempts w/incomplete Cyberspear
                    ...
                    scr_event_build_quest_state("crustDoorIncomplete", 1); // Add 1 attempt
            ...
            //---------------------
                ...
                if (scr_quest_get_state("crustDoorComplete") == 0) { // First time with complete spear.
                    ...
                    // Solo = approached or not. With incomplete spear = approached but not entered.
                        scr_event_build_dialogue("Cyberdwarf", s_port_cd, "Finally, we are ready my child. When we cross this threshold, Cuchulainn will certainly set his strongest forces against us, with the Cyberspear in hand, we have nothing to fear. Open the door, child and face Cuchulainn. Destroy him once and for all!");
