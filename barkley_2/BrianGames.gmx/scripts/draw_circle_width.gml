/// draw_arc(x, y, radius, width, offset, stage)
//Atypical arc
...
for (_i = 0; _i < _prt; _i += 1)
{
    ...
    //draw_sprite_ext(s_sine64, 0, _dx0, _dy0, _rcl, _rcl, 0, draw_get_color(), (0.33 + random(0.1)) * draw_get_alpha());
    draw_set_alpha(_alp0);
    draw_line_width(_dx0, _dy0, argument[0], argument[1], _wid + (_stg - 1)); //was stage
    draw_set_alpha(_alp0);
