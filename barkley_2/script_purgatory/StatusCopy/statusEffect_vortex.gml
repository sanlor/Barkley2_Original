...
if (string(argument[0]) == "applyBullet")
{
    ...
    {
        var conf;
        conf = scr_statusEffect_addToCombatAttack(statusEffect_vortex, _bullet);
...
if (command == "generate") then 
    ...
    scr_statusEffect_generateBasicInfo(conf, statusEffect_vortex, 120);
...
// APPLY THIS STATUS EFFECT //
    ...
    var currentWithering = scr_statusEffect_getFromCombatActor(actor, statusEffect_vortex);
