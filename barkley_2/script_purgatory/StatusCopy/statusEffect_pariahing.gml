...
if (string(argument[0]) == "applyBullet")
{
    ...
    {
        var conf;
        conf = scr_statusEffect_addToCombatAttack(statusEffect_pariahing, _bullet);
...
if (command == "generate") then 
    ...
    scr_statusEffect_generateBasicInfo(conf, statusEffect_pariahing, 80);
...
// APPLY THIS STATUS EFFECT //
    ...
    var currentPagan = scr_statusEffect_getFromCombatActor(actor, statusEffect_pariahing);
