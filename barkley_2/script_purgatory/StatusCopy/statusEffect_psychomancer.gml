...
if (string(argument[0]) == "applyBullet")
{
    ...
    {
        var conf;
        conf = scr_statusEffect_addToCombatAttack(statusEffect_psychomancer, _bullet);
...
if (command == "generate") then 
    ...
    scr_statusEffect_generateBasicInfo(conf, statusEffect_psychomancer, 120);
...
// APPLY THIS STATUS EFFECT //
    ...
    var currentWithering = scr_statusEffect_getFromCombatActor(actor, statusEffect_psychomancer);
