...
else if (argument[0] == "db") // @@@@@ SET THE VALUES FOR ART, NOTES, AND CHARACTERS HERE @@@@@ //
{
    ...
    //LONGINUS
    Note("add note", 19, "Top Secret Dossier", "sn_mnu_noteFlipHeavy01", "BAK|s_tnn_papers|19");
    ...
    Note("add person", "Birgit", "Deliver What Letter...?", event_placeholder);
    Note("add person", "Cuthbert", "Submit Which Application...?", event_placeholder);
