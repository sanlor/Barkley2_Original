...
if (argument[0] == "db")
{
    ...
    Candy("define", "Wilmer's Neue",  01, 000, 015, "CRUNCH!", "+100 HP, +5 GUTS for 10 seconds",         "Makes the weak strong and the feeble emboldened. A unique and arcane recipe.");
    Candy("define", "Chickenfry Dew", 02, 030, 015, "BITE!",   "+10 PIETY for 60 seconds",                "From the first one. Decent snack. Wet.");
    Candy("define", "Sweet Sweat",    03, 050, 010, "SLURP!",  "Remove all Ailments",                     "The sweat of a sweet. Cures what ails you.");
    Candy("define", "Black Licorice", 04, 060, 005, "GOMP!",   "Ailment Immunity for 30 seconds",         "Tastes like anise. So bad, nothing else matters.");
    ...
    Candy("effect", "Chickenfry Dew", "pietyBoost", 10, 60);
    Candy("effect", "Chickenfry Dew", "heal", 100);
    ...
    Candy("effect", "Sweet Sweat", "heal", 100); // antidote
