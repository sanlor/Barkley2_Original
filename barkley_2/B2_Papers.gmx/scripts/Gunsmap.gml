...
if (argument[0] == "init")
{
    ...
    Gunsmap("define", "SMG",           "Automatic",      18, make_colour_hsv(130, 128, 128));
    Gunsmap("define", "Assault",       "Automatic",      18, make_colour_hsv(140, 128, 128));
    Gunsmap("define", "Machinegun",    "Automatic",      12, make_colour_hsv(150, 128, 128));
    Gunsmap("define", "Uzi",           "Automatic",      12, make_colour_hsv(160, 128, 128));
...
else if (argument[0] == "draw64") // 1 = x, 2 = y, 3 = gunType, 4 = gunPos
{
    ...
    // Draw marker
    mrkScl = 1;
    draw_sprite_ext(sMenuUtilityGunMapMarker, 2, drx + gnx, dry + gny, mrkScl, mrkScl, 0, c_white, image_alpha);
}
else if (argument[0] == "fuse") // 1 = topTyp, 2 = topPos, 3 = botTyp, 4 = botPos, 5 = gunPow
{
