...
MATTHIAS
DIALOG | Wilcy    | You don't look so good. Maybe it's best if you rest somewhere.
DIALOG | Matthias | No way Jose!! Who needs to rest when you're as alive and well as me, Matthias!!!
DIALOG | Wilcy    | Could have fooled me.

GOVERNOR
DIALOG | Wilcy    | You again. I don't give a damn what the rules say, I'm going to keep sitting here. You'd be doing me a favor by putting a bullet in my head and having one of your goons drag me away.
...
DIALOG | Wilcy    | I feel as though the lucky ones were those who got to see their world in flames for one last moment than five months of staring at the last hope of my people systematically losing the will to live.
CHOICE | .....
...
DIALOG | Wilcy    | Well you fucking blew it. Just leave me alone. That's all I ever wanted you to do in the first place.
QUEST  | wilcyState = 4
...
DIALOG | Wilcy    | But she's gone now. They're all gone.
DIALOG | Wilcy    | Now I'm all that's left.
DIALOG | P_NAME   | .....
...
DIALOG | P_NAME   | Yes.
DIALOG | Wilcy    | Wow....
DIALOG | Wilcy    | You don't know how envious of you I am. To forget...
DIALOG | Wilcy    | Maybe in another life you could call that a curse. In this one...
DIALOG | Wilcy    | ...it's a gift.
QUEST  | wilcyState = 2
...
WILCY4
DIALOG | Wilcy    | Fuck off. I'm through talking to you.
";
