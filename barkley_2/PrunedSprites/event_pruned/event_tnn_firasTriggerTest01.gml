...
//--------------------------------------------
    ...
    with (firasFail) {
        ...
        scr_event_build_set_object(o_cts_hoopz, 1790, 210); 
        scr_event_hoopz_switch_control();
    ...
    with (firas3) {
        ...
        scr_event_build_execute_event_script(event_tnn_firasTriggerTest01);
    }
    ...
    //Currently controlling Matthias
     if (scr_quest_get_state("deadSon") == 3) {
        ...
        //deadSonHandler = 0, haven't started event yet.
            ...
            scr_event_build_wait_for_actions(); 
            scr_event_hoopz_switch_control();
            scr_event_build_set_object(o_cts_hoopz, 1785, 270);
            scr_event_hoopz_switch_control();
            scr_event_build_fade(false, 2);
            scr_event_build_wait_for_actions(); 
            ...
            with scr_event_build_add_choice(startquest, "I'm not ready yet, I should find out more about Matthias.") {
                ...
                scr_event_build_wait_for_actions();
                scr_event_hoopz_switch_control();
                scr_event_build_set_object(o_cts_hoopz, 1785, 340); 
                scr_event_hoopz_switch_control();
                scr_event_build_fade(false, 2);
                scr_event_build_wait_for_actions(); 
            }
