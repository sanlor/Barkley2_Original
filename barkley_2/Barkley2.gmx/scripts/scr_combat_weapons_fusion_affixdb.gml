...
{
    // EMPTY
    scr_combat_weapons_fusion_affixhood("create prefix1", "empty", "empty", "empty", "");// Empty prefix must always be created
...
{
    // EMPTY
    scr_combat_weapons_fusion_affixhood("create suffix", "empty",                           "empty", "empty", "empty", "", statusEffect_null);// Empty prefix must always be created
    ...
    //scr_combat_weapons_fusion_affixhood("create suffix", "of Pensioning",                   "up", "cyber", "reactive",          "Bullets move extremely slow.", scr_combat_weapons_suffix_of_pensioning);
}
...
// GAMER ABYSS BELOW //
    ...
    /*scr_combat_weapons_fusion_affixhood("create suffix", "of the Doxxer",                   "up", "cyber", "aggressive", "50% of bullet damage is CYBER.");
    scr_combat_weapons_fusion_affixhood("create suffix", "of Perpetual War",                "up", "cyber", "passive", "Each shot has a 2% chance to restore 2% of your total ammo.");
    scr_combat_weapons_fusion_affixhood("create suffix", "of Caltropix",                    "up", "cyber", "reactive", "Bullet casings/shells turn into caltrops after they land and stop moving.");
    
    
    scr_combat_weapons_fusion_affixhood("create suffix", "with a hole in the pocket",       "up", "mental", "passive", "Constantly depletes ammunition (except while shooting).");
    ...
    scr_combat_weapons_fusion_affixhood("create suffix", "of the Let's Plays",              "strange", "cyber", "reactive", "Add Description");
        ...
        scr_combat_weapons_fusion_affixhood("create suffix", "of Bailing Out",                  "strange", "mental", "reactive", "A surge of movement speed and 20% heal when you run out of ammo.");
