...
if (string(argument[0]) == "applyBullet")
{
    ...
    {
        var conf;
        conf = scr_statusEffect_addToCombatAttack(statusEffect_pozzosPrison, _bullet);
...
if (command == "generate") then 
    ...
    scr_statusEffect_generateBasicInfo(conf, statusEffect_pozzosPrison, 50);
...
// APPLY THIS STATUS EFFECT //
    ...
    var currentAdhesive = scr_statusEffect_getFromCombatActor(actor, statusEffect_pozzosPrison);
