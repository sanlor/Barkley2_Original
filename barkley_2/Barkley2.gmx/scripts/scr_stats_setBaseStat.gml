/// scr_stats_setBaseStat(combatactor_id, stat, value)
...
switch (stat) {
    ...
    default:
        show_debug_message("Invalid stat for scr_stats_setBaseStat: " + stat);
        return 0;
        break;
}
...
with (actor) {
    ds_map_replace(stats_base, stat, value);
    doGenEffectiveStats = true;
    changedStatsBase = true;
}
