/// scr_path_set_diag(start_x,start_y,end_x,end_y,path_speed,length_min,length_max, allowdiag)
...
var allow_diag = argument7; //allow diag?
...
if (dist >= length_min && (length_max == NULL or dist <= length_max)) { // if destination is far enough  
    ...
    } else { // if path not succesfully generated
        scr_path_delete();
        return false;
    }
}
