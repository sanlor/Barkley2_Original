...
else if (argument[0] == "res_normal") return 0;
else if (argument[0] == "res_bio") return 0;
else if (argument[0] == "res_cyber") return 0;
else if (argument[0] == "res_cosmic") return 0;
else if (argument[0] == "res_mental") return 0;
else if (argument[0] == "res_zauber") return 0;
