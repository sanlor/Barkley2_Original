/// zauber_enemy_catfishQueen_bubblesLarge(command, caster, target_data, level)
...
if (command == "cast") {
    ...
    var bubbleAbility = floor(piety * 0.4); // it takes more effort to make large bubbles than small ones
    var numBubbles = max(1, bubbleAbility); // we always want to show one bubble
    
    var n = instance_create(aim_x, aim_y, o_zauber_queenBubblesLarge);
