...
else if (command == "changestat")
{
    ...
    {
        statusHelper_resistBoost(actor, statusEffect_stat, 1 + (conf[? "strength"] * global.statusResistBoostOne), 1 - (conf[? "strength"] * global.statusResistLowerRest));
    }
    return 0;
}
