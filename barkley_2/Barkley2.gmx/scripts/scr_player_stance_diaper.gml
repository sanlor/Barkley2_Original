...
if (Quest("diaperDodge"))
{
    if(dodgeCooldown <= 0)
    {
        ...
        {
            // Execute dodge
            global.stanceBeforeRoll = scr_player_stance_diaper;
...
if (input_dist > 0 or shuffle > 0) {
    ...
    scr_entity_animation_setFrame(ANIMATION_DEFAULT, 0); // This is the 'standing still' frame
...
// Set draw script
scr_player_setDrawScript(scr_player_draw_walking_diaper_standard)
