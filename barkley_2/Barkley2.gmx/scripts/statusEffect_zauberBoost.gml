// Periodic raises target ZAUBER resistence XX%, lowers other resistences YY%.
statusEffect_this = statusEffect_zauberBoost; // MUST change this to be name of the script above
