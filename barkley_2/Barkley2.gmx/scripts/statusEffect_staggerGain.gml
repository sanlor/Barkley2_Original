// Periodic raises target stagger resistence X%, WEIGHT Y%.
statusEffect_this = statusEffect_staggerGain;
...
else if (command == "changestat")
{
    ...
    {
        statusHelper_statMultiply(actor, STAT_BASE_RESISTANCE_STAGGER, 1 + (1.0 * conf[? "strength"]));
    }
    return 0;
}
