...
if (argument[0] == "init") // Define jerkins in here
{
    ...
    Jerkin("define", "Cornhusk Jerkin",     00, 04, 04, 0,  "+020", "+030", "-020", "+010", "+000", "-050", "Protective outer covering of a once-anointed cob of maize."); // This husk was removed at the peak time, when the endosperm was in the 'milk stage'.  This means you can be guaranteed a firmer defense against piercing weapons.
    ...
    Jerkin("define", "Bisphenol A Jerkin",  07, 08, 08, 0,  "+100", "+025", "+025", "+025", "-100", "+025", "Not much is known about this jerkin.");
    Jerkin("define", "Kangaroo Skin",       08, 08, 06, 0,  "+000", "+000", "+000", "+000", "+000", "+000", "This Kangaroo Skin is rimmed with pockets.");
    Jerkin("define", "Gilbert's Pique",     09, 04, 03, 0,  "+020", "+010", "+010", "+010", "+100", "+010", "Jerkin worn by the legendary Gilbert.");
    Jerkin("define", "Bespoke Jerkin",      10, 05, 06, 0,  "+030", "-030", "+050", "+010", "+000", "-100", "A jerkin all to oneself.");
