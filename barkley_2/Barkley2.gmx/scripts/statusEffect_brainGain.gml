// Periodic raises target BRAIN XX%, lowers DEFENSE YY%.
statusEffect_this = statusEffect_brainGain;
...
else if (command == "apply")
{
    ...
    actor.AI_decisionFrequency = actor.thinkfluencing * (1 - (1.0 * conf[? "strength"]));
    return 0;
} 
